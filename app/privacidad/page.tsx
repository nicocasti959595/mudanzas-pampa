  ...
  return (
    <LegalLayout title="Política de privacidad" updated="Junio 2026">
      ...
      <p>
        ...
        teléfono: nombre, número de teléfono, origen y destino de la mudanza y el
        detalle de lo que necesitás trasladar.
      </p>

      <h2>Para qué los usamos</h2>
      <p>
        Usamos tus datos exclusivamente para responder tu consulta, elaborar el
        presupuesto, coordinar la mudanza o el flete y darte seguimiento. No los
