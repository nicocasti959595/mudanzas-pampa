...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50">
      {/* Barra superior */}
      <div className="bg-brand-deep text-white text-[13px] sm:text-sm">
        <div className="mx-auto max-w-7xl px-4 h-9 flex items-center justify-center sm:justify-between gap-3">
          <p className="font-semibold tracking-wide flex items-center gap-2">
            ...
            PRESUPUESTO SIN CARGO · PERSONAL ASEGURADO
          </p>
          <a
            href={telLink}
      ...
      >
        <nav className="mx-auto max-w-7xl px-4 h-16 flex items-center justify-between">
          <a href="#top" className="flex items-center gap-2.5 group">
            <span className="grid place-items-center h-10 w-10 rounded-xl bg-gradient-to-br from-brand-bright to-brand-deep text-ink shadow-lg shadow-brand/20 group-hover:scale-105 transition">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="hidden sm:inline-flex items-center gap-2 rounded-xl bg-brand px-4 py-2.5 text-sm font-bold text-ink hover:bg-brand-bright transition shadow-lg shadow-brand/25"
            >
            ...
            <ul className="px-4 py-3 space-y-1">
              ...
              <li className="pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 rounded-xl bg-brand px-4 py-3 font-bold text-ink"
                >
