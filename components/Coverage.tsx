...
export default function Coverage() {
  return (
    <section id="zonas" className="relative py-20 sm:py-28 overflow-hidden">
      <div className="absolute -left-20 top-10 -z-10 h-80 w-80 rounded-full bg-route/10 blur-[120px]" />
      <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-4 text-mist max-w-lg">
            Llegamos con nuestros camiones y personal a tu domicilio, oficina o
            comercio para mudarte. También hacemos mudanzas de larga distancia al
            interior del país. Estos son algunos de los barrios y localidades donde
            trabajamos a diario:
          </p>
          ...
          <ul className="mt-6 flex flex-wrap gap-2">
            {zones.map((z) => (
              <li
                key={z}
                className="inline-flex items-center gap-1.5 rounded-full border border-line bg-steel/50 px-3 py-1.5 text-sm text-white/85 hover:border-brand/40 hover:text-white transition"
              >
          ...
          <a
            ...
            className="mt-7 inline-flex items-center gap-2 rounded-xl bg-brand px-5 py-3 text-sm font-bold text-ink hover:bg-brand-bright transition"
          >
        ...
        <div className="relative">
          <div className="glass rounded-3xl p-3 shadow-2xl">
            <div className="overflow-hidden rounded-2xl border border-line">
              <iframe
                ...
                src="https://www.openstreetmap.org/export/embed.html?bbox=-58.62%2C-34.74%2C-58.30%2C-34.52&layer=mapnik&marker=-34.5998%2C-58.4445"
          ...
          <div className="absolute -top-4 -right-3 flex items-center gap-2 rounded-2xl bg-white px-4 py-3 text-ink shadow-xl">
            <IconMap className="h-6 w-6 text-brand-deep" />
