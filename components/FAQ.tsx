      ...
      <div className="mx-auto max-w-4xl px-4">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="mt-3 font-display text-3xl sm:text-4xl font-extrabold text-white">
            Todo lo que querés saber antes de mudarte
          </h2>
        </div>
            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition ${
                  isOpen ? "border-brand/40 bg-steel/50" : "border-line bg-steel/30"
                }`}
              >
                <button
                ...
                >
                  ...
                  <span
                    className={`grid place-items-center h-7 w-7 shrink-0 rounded-full border border-line text-brand transition ${
                      isOpen ? "rotate-45 bg-brand/10" : ""
                    }`}
                  >
        ...
        <p className="mt-10 text-center text-mist">
          ...
          <a
            ...
            className="font-semibold text-brand underline underline-offset-4 hover:text-brand-bright"
          >
