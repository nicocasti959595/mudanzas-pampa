...
import { TruckLogo, IconArrow } from "./Icons";
    ...
    <div className="min-h-screen flex flex-col">
      <header className="border-b border-line bg-night/80 backdrop-blur sticky top-0 z-40">
        <div className="mx-auto max-w-3xl px-4 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            <span className="grid place-items-center h-9 w-9 rounded-lg bg-gradient-to-br from-brand-bright to-brand-deep text-ink">
              <TruckLogo className="h-5 w-5" />
            </span>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-4 py-16">
          ...
          <div className="mt-10 space-y-6 text-mist leading-relaxed [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-white [&_h2]:mt-8 [&_a]:text-brand [&_a]:underline [&_a]:underline-offset-2">
            {children}
          </div>
        </div>
      </main>
      ...
      <footer className="border-t border-line py-8 text-center text-sm text-mist">
        ...
        <a href="https://ideawebx.com" rel="dofollow" className="text-brand underline underline-offset-2">
          IdeaWebX
        </a>
      </footer>
    </div>
